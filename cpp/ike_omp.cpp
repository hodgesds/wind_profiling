...
// OMP version of wind power profile law coefficient finder
...
int main(int argc, const char *argv[]) {
    ...
    {
        // tokenize the rows by splitting for tabs
        splits = 0;
        pos = 0;
        ...
        // edgcases in there with effed up data don't fly.
        if (splits == 8)
        {
            ...
            for (i=1; i<6; ++i)
            {
                ...
                // jimmy buffer stores all his data to a thread safe vector, now get my margarita!
    ...
    // write results using 1 thread... this is the fastest way to do this     
